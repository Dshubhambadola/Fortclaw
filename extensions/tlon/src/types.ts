...
export function resolveTlonAccount(cfg: FortclawConfig, accountId?: string | null): TlonResolvedAccount {
...
export function listTlonAccountIds(cfg: FortclawConfig): string[] {
  const base = cfg.channels?.tlon as
