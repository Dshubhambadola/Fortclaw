...
public final class GatewayDiscoveryModel {
    ...
    public func start() {
        ...
        for domain in FortclawBonjour.gatewayServiceDomains {
            let params = NWParameters.tcp
            params.includePeerToPeer = true
            let browser = NWBrowser(
                for: .bonjour(type: FortclawBonjour.gatewayServiceType, domain: domain),
                using: params)
    ...
    private func updateGateways(for domain: String) {
        ...
        if domain == FortclawBonjour.wideAreaGatewayServiceDomain,
    ...
    private nonisolated static func prettifyInstanceName(_ decodedName: String) -> String {
        ...
        let stripped = normalized.replacingOccurrences(of: " (Fortclaw)", with: "")
