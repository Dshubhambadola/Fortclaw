...
final class PeekabooBridgeHostCoordinator {
    ...
    private var services: FortclawPeekabooBridgeServices?
    ...
    private func startIfNeeded() async {
        ...
        let services = FortclawPeekabooBridgeServices()
...
@MainActor
private final class FortclawPeekabooBridgeServices: PeekabooBridgeServiceProviding {
