...
Fortclaw has two separate “streaming” layers:
...
When block streaming is enabled, Fortclaw can **merge consecutive block chunks**
...
When draft streaming is active, Fortclaw disables block streaming for that reply to avoid double-streaming.
