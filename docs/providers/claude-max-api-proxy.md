...
You can point Fortclaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Fortclaw
...
- [Anthropic provider](/providers/anthropic) - Native Fortclaw integration with Claude setup-token or API keys
