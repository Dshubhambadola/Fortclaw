...
read_when:
  - Setting up Zalo Personal for Fortclaw
...
- On startup, Fortclaw resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
