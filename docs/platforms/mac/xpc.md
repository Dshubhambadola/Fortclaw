---
summary: "macOS IPC architecture for Fortclaw app, gateway node transport, and PeekabooBridge"
read_when:
  - Editing IPC contracts or menu bar app IPC
---
# Fortclaw macOS IPC architecture
...
- Host preference order (client-side): Peekaboo.app → Claude.app → Fortclaw.app → local execution.
